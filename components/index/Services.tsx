...
const SERVICES: Service[] = [
  { 
    ...
    description: "Logos, visual systems, and guidelines that define your unique presence",
    Icon: Palette,
    color: "bg-[#DCDFFF]",
  },
  { 
  ...
  { 
    title: "Motion Design", 
    description: "Animations and videos that capture attention and tell stories",
    Icon: Video,
    color: "bg-[#F5F5F5]",
  },
  { 
  ...
  { 
    ...
    description: "Research-driven strategies that position you for success",
    Icon: Zap,
    color: "bg-[#F5F5F5]",
  },
];
      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 sm:mb-20">
          ...
          <p className="text-lg sm:text-xl text-gray-500 max-w-2xl mx-auto">
            End-to-end creative solutions that help brands stand out, connect with audiences, and drive results.
          </p>
        </div>
        ...
        >
          {SERVICES.map(({ title, description, Icon, color }) => (
            ...
            >
              ...
              {/* Decorative element */}
              <div className="absolute -bottom-10 -right-10 w-32 h-32 rounded-full bg-black/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </motion.div>
          ))}
        </motion.div>
      </div>
