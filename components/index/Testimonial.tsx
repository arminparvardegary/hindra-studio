...
const testimonials = [
  {
    quote: "Hindra transformed our brand completely. The attention to detail and strategic thinking was exactly what we needed.",
    author: "Sarah Chen",
    role: "CEO, TechFlow",
  ...
  {
    quote: "Working with Hindra was a game-changer. They delivered beyond our expectations, on time and within budget.",
  ...
  {
    quote: "The team's creativity and professionalism are unmatched. Our website conversions increased by 200% after the redesign.",
  ...
  {
    quote: "From concept to execution, Hindra exceeded every expectation. They're not just designers, they're strategic partners.",
    author: "David Kim",
  ...
  {
    quote: "The motion design work was incredible. Our product videos now consistently outperform industry benchmarks.",
    author: "Lisa Park",
...
export default function Testimonial() {
  ...
  return (
    <section className="w-full py-20 overflow-hidden bg-[#FAFAFA]">
      {/* Section Header */}
      ...
      >
        ...
        >
          {infiniteCards.map((card, i) => (
            ...
            >
              <div>
                <svg className={`w-10 h-10 mb-4 ${card.textColor ? "text-white/30" : "text-black/20"}`} viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="flex items-center gap-4 mt-6">
                ...
                <div>
                  <p className={`font-semibold ${card.textColor || "text-black"}`}>{card.author}</p>
